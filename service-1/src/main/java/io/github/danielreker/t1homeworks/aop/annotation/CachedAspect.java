package io.github.danielreker.t1homeworks.aop.annotation;

import io.github.danielreker.t1homeworks.aop.data.CacheEntry;
...
public class CachedAspect {
    ...
    @Around("@annotation(io.github.danielreker.t1homeworks.aop.annotation.Cached)")
